...
<?php
						...
						$message = "DETAILS\n";
						$message .= "Service provided: " . $_POST['rating-input-1'];
						$message .= "\nProduct's quality: " . $_POST['rating-input-2'];
						$message .= "\nSupport: " . $_POST['rating-input-3'];
						$message .= "\nGeneral satisfaction: " . $_POST['rating-input-4'];
						$message .= "\nReview: " . $_POST['review'] . "\n";
						$message .= "\nUSER DETAILS";
